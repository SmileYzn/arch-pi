...
executar()
{
  ...
  case $1 in
    ...
    ;;
    11)
      sudo pacman -S --needed --noconfirm ark filelight gwenview kate kcalc kcharselect kcolorchooser kfind kolourpaint kwalletmanager okular partitionmanager plasma-systemmonitor vlc
    ;;
    12)
